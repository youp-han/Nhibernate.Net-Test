...
using FirstSolution.Repository;
...
namespace FistSolution.Test
{
    ...
    class ProductRepository_Fixture
    {
        ...
        {
            var product = new Product { Name = "Apple", Category = "Fruit" };
        ...
        {
            IProductRepository repositoary = new ProductRepository();
            var fromDb = repositoary.GetById(_products[1].Id);
            Assert.IsNotNull(fromDb);
        ...
        [Test]
        public void can_get_existing_product_by_category()
        {
            IProductRepository repository = new ProductRepository();
